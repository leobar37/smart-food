...
import { InjectSupabase, SupabaseClient } from '../providers';
import { SUPABASE_TABLES } from '@App/constants';
import { PRODUCTS_DATA } from '../data/default-buildeable-plates';
import { BuildeableProduct, Option } from '../types';
import { pick } from 'lodash';
import { isDev } from '@App/utiliies';
@Injectable()
export class ProductBuildeableService implements OnModuleInit {
  ...
  /**
   *
   * - This is only for populate the database, not recommended to use in production  because supabase not support transaction out the box yet
   * TODO:
   * - further down this has to be moved to the scripts folder and use https://github.com/Pop-Code/nestjs-console/wiki
   */
