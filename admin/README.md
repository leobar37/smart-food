...
To view the config for your new app, look at [./keystone.ts](../../admin/keystone.ts)
...
Just change the `db` property on line 16 of the Keystone file [./keystone.ts](../../admin/keystone.ts) to
...
We've put auth into its own file to make this humble starter easier to navigate. To explore it without auth turned on, comment out the `isAccessAllowed` on line 21 of the Keystone file [./keystone.ts](../../admin/keystone.ts).
